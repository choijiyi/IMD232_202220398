class Emitter {
    constructor(emittingPosX, emittingPosy) {
        this.emittingPos = createVector(x, y);
        this.balls = [];
    }

    createBall() {
        this.balls.push(new Ball(this.emittingPos.x, this,emmittingPos.y, random(1,5), random(360), 100, 50));
    }
